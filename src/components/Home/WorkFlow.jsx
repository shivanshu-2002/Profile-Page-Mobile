  ...
  return (
    <div className='text-white bg-white w-[100%]  py-5 flex flex-col items-center justify-center  gap-[3%]'>
      ...
      <div className='absolute   sm:w-[32%] w-[40%] right-0  top-0 h-full flex flex-col justify-between sm:gap-5 gap-10 '>
        <div className='    w-[100%] h-[45%] flex flex-col items-center justify-between z-20'>
          <div className='h-[40%] w-full flex justify-center'>
            <img src={wf2} width={'27%'} alt="Left Pillar Top Image" />
          </div>
          <div className='w-[100%]  text-black flex flex-col items-center justify-center'>
            <div className='sm:text-lg text-[15px] text-center  leading-4 font-semibold'>Collaborative Workspace</div>
        ...
        <div className='absolute bottom-0  mt-10 left-0 w-[100%] h-[45%]  flex flex-col items-center  justify-between z-20'>
          <div className='h-[40%] w-full flex justify-center'>
      ...
      <div className='w-[55vh] h-[55vh]    rounded-full  flex items-center justify-center'>
        <div className='sm:w-[35vh] sm:h-[35vh] w-[22vh] h-[22vh] rounded-full'>
